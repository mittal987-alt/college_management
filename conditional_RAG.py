...
def academic_rag_node(state: State) -> dict:
    ...
    for doc in docs:
        ...
        context_chunks.append(f"[Source: Page {page_num}]\n{doc.page_content}")
...
def response_node(state: State) -> dict:
    ...
    if context == "NO_RETRIEVAL_NEEDED":
        ...
        prompt = (
            ...
            f"the question accurately. The context includes [Source: Page X] markers. "
            f"Always cite the source page(s) in your answer (e.g., 'According to page X...'). "
